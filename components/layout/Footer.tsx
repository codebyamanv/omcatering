                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
                    ...
                    <div>
                        <div className="flex items-center gap-3 mb-6">
                            <div className="w-14 h-14 overflow-hidden rounded-full bg-primary flex items-center justify-center font-heading font-bold text-xl text-white">
                        ...
                        <p className="text-gray-400 mb-6 leading-relaxed">
                            Your trusted partner for premium catering, travel, and event planning services across India.
            ...
            <div className="border-t border-white/10">
                <div className="container-custom py-6">
                    <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                        ...
                        <p className="text-gray-500 text-sm">Designed with ❤️ in Varanasi, India. #codebyamanv</p>
                    </div>
                </div>
            </div>
        </footer>
